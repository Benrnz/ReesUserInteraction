...
{
    /// <summary>
    /// A Wpf implementation of a simple Windows Input box that prompts the user to enter some text with an Ok and Cancel button.
    /// </summary>
    public class WindowsInputBox : IUserInputBox
    {
        ...
        /// <summary>
        /// Gets or sets the input. Setting this before display, will default the text. After the user has clicked Ok, this will contain the user's text.
        /// </summary>
